...
if __name__ == "__main__":
    ...
    for e in range(EPISODES):
        ...
        for time in range(0, 100000000):
            ...
            next_state = cv2.resize(next_state, (84, 110))
            next_state = next_state[26:110, 0:84]
